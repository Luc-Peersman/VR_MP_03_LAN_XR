...
namespace TryAR.MarkerTracking
{
    ...
    public class ArUcoMarkerTracking : MonoBehaviour
    {
        ...
        /// <summary>
        /// Rauwe, camera-relatieve pose per marker-ID (positie/rotatie t.o.v. de
        /// camera-lens, in meters), VOORDAT er gefilterd of naar wereldcoördinaten
        /// omgezet wordt. Toegevoegd voor zuivere validatie/debug-doeleinden -
        /// geen omweg via de Unity-wereld nodig om dit af te lezen.
        /// </summary>
        public Dictionary<int, PoseData> LastRawPoseInCameraSpace { get; } = new Dictionary<int, PoseData>();
            ...
            ))
            {
                ...
                for (int i = 0; i < _detectedMarkerCorners.Count; i++)
                {
                    ...
                    using (MatOfPoint2f imagePoints = new MatOfPoint2f(corner_4x1))
                    {
                        ...
                        // Sla de RAUWE, camera-relatieve pose op (nog VOORDAT er
                        // gefilterd of naar wereldcoördinaten omgezet wordt). Dit
                        // is de zuivere, foto-gebaseerde meting: positie/rotatie
                        // van de marker t.o.v. de camera-lens, in meters, zonder
                        // enige omweg via de Unity-wereld.
                        LastRawPoseInCameraSpace[currentMarkerId] = poseData;

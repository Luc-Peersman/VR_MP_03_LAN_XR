...
namespace XRMultiplayer
{
    ...
    public class VoiceChatManager : MonoBehaviour
    {
        ...
        {
            // Vivox (Unity's cloud-gebaseerde voice-chat) vereist internet om te
            // initialiseren. Op dit LAN-only project (geen internet) blijft
            // VivoxService.Instance null - check dit expliciet om een NullReferenceException
            // te voorkomen die anders elke frame in Update() zou optreden.
            if (VivoxService.Instance == null)
                return;
